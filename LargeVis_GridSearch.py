...
############   largevis test  #####################
    ...
    best_auc_score = 0
    for perp_value in tot_perp_gourp:
        for neg_value in tot_neg_group:
            for gamma_value in tot_gamma_group:
                for neigh_value in tot_neigh_group:
                    ...
                    print("Applying LargeVis with perp = {perp_value}, neg = {neg_value}, gamma = {gamma_value}, neigh = {neigh_value}".format(perp_value = perp_value, neg_value = neg_value, gamma_value = gamma_value, neigh_value = neigh_value))
                    ...
                    print("Computing the DR quality of the result of LargeVis with perp = {perp_value}, neg = {neg_value}, gamma = {gamma_value}, neigh = {neigh_value}".format(perp_value = perp_value, neg_value = neg_value, gamma_value = gamma_value, neigh_value = neigh_value))
                    ...
                    L_rnx.append(rnxk)
                    #L_kg.append(kg)
                    Ltime.append("{running_time} with perp = {perp_value}, neg = {neg_value}, gamma = {gamma_value}, neigh = {neigh_value}".format(running_time = elapsed_time, perp_value = perp_value, neg_value = neg_value, gamma_value = gamma_value, neigh_value = neigh_value))
                    Lleg_rnx.append("AUC_score {AUC_score} with perp = {perp_value}, neg = {neg_value}, gamma = {gamma_value}, neigh = {neigh_value}".format(AUC_score = auc_value, perp_value = perp_value, neg_value = neg_value, gamma_value = gamma_value, neigh_value = neigh_value))
    ...
    print("********************* ")
    print("Best score:{:.2f}".format(best_auc_score))
