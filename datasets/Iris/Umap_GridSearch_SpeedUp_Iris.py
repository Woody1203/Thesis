...
def save_dfs_and_heatmaps(path, List_time, List_auc, variable_target1, variable_target2, variable1, variable2, variable3, variable4,  dataset_name, algorithm):
...
############   UMAP test   #####################
    ...
    # number of threads
    threads_list = [1, 2, 4]
    path = r'C:/Users/15754/Desktop/LDATE2990 - Master Thesis/Project/results/datasets/Iris/umap/'
    ...
    save_dfs_and_heatmaps(path, List_time, List_auc, variable_target1, variable_target2, variable1, variable2, variable3, variable4,  dataset_name, algorithm)
