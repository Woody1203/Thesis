...
if __name__ == '__main__':
    ...
    try:
        ...
        id_subs = rand_state.choice(a=X_hds.shape[0], size=1200, replace=False)
        ...
        print("the size of the dataset is less than 1200")
        print("the size of dataset is:", X_hds.shape)
    ...
    # number of threads
    threads_list = [1, 2, 4]
    path = r'C:/Users/15754/Desktop/LDATE2990 - Master Thesis/Project/results/datasets/digit/t-sne/'
