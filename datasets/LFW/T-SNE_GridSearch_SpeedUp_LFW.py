...
import LargeVis
import argparse
from sklearn.datasets import load_wine, load_breast_cancer, fetch_lfw_people
...
if __name__ == '__main__':
    ...
    X_hds = lfw_people.data
    labels = lfw_people.target

    try:
        rand_state = np.random.RandomState(0)
        id_subs = rand_state.choice(a=X_hds.shape[0], size=100000, replace=False)
        ...
        print("the size of the dataset is less than 100000")
        print("the size of dataset is:", X_hds.shape)
    ...
    # number of threads
    threads_list = [1, 2, 4]
    path = r'C:/Users/15754/Desktop/LDATE2990 - Master Thesis/Project/results/datasets/LFW/t-sne/'
