...
############   UMAP test   #####################
    ...
    # number of threads
    threads_list = [1, 2, 4]
    path = r'C:/Users/15754/Desktop/LDATE2990 - Master Thesis/Project/results/datasets/Wine/largevis/'
        ...
        for neg_value in tot_largevis_neg_group:
            for gamma_value in tot_largevis_gamma_group:
                for neigh_value in tot_largevis_neigh_group:
                    ...
                    print("Applying " + str(algorithm)+ " for value in variable with perp = {perp_value}, neg = {neg_value}, gamma = {gamma_value}, neigh = {neigh_value}".format(perp_value = perp_value, neg_value = neg_value, gamma_value = gamma_value, neigh_value = neigh_value))
                    ...
                    if auc_value > best_auc_score:#找到表现最好的参数
                        ...
                        best_parameters = {str(variable1) :perp_value, str(variable2):neg_value, str(variable3): gamma_value, str(variable4):neigh_value}
