...
############   UMAP test   #####################
    ...
    try:
        ...
        print("after subsampling", X_hds.shape)
    except:
...
############   largevis test  #####################
    ...
    tot_umap_negative_sample_rate_group = [3,5,10,50] # default = 5
        ...
        for min_dist_value in tot_umap_min_dist_group:
            for spread_value in tot_umap_spread_group:
                for negative_sample_rate_value in tot_umap_negative_sample_rate_group:
                    ...
                    print("Applying UMAP with n_neighbors = {n_neighbors}, min_dist = {min_dist}, spread = {spread}, negative_sample_rate = {negative_sample_rate}".format(n_neighbors = n_neighbors_value, min_dist = min_dist_value, spread = spread_value, negative_sample_rate = negative_sample_rate_value))
                    ...
                    if auc_value > best_auc_score:#找到表现最好的参数
                        ...
                        best_parameters = {'n_neighbors':n_neighbors_value,'min_dist':min_dist_value, 'spread': spread_value, 'negative_sample_rate':negative_sample_rate_value}
